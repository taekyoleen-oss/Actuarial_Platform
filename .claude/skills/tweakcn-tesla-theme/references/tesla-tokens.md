...
| --brand-navy | #1B2845 | 보조 네이비 (예비 — 현재 미사용) |
...
| 카드 제목 | 17–18px | 600 | Pretendard(고딕) · --brand-sky 로고 블루 (설명과 구별, hover --primary) |
| 내비/버튼 | 14px | 500 | |
...
- Inter: 라틴 폴백.
- weight 400/500만 임포트. 300/700 임포트 금지. (카드 타이틀 600은 Pretendard 패키지에 포함된 웨이트 사용)
- 별도 세리프 폰트 로딩 없음 (2026-06-11: 카드 타이틀 세리프 안 → 고딕·로고 블루로 확정).
