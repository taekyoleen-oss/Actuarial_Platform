...
| 2026-07-10 | 지구본 워터마크 가시성 강화 + 홈 글래스 카드 투명도 상향 | app/globals.css, app/(public)/page.tsx | 사용자 요청: 지구본이 더 잘 보이게 — 워터마크 0.15→0.28, 글래스 카드 --card-glass-bg 0.34→0.2·벤토 0.22→0.12·관련링크 0.35→0.2·hover 0.52→0.4, blur 7→4px(마크 선명도). .home-glass 공유라 배타권 목록 카드도 동일 상향 |
